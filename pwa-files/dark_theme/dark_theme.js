...
function dark_theme(theme) {
  if (theme !== "light") {
    ...
    if (
      ...
      style1.innerHTML =
        ".donut-segment-2 { stroke: var(--primary_text)!important; }";
      ...
      style4.innerHTML =
        ".pr-open { background: none!important; color: rgb(93 93 93); }";
      ...
      function changecolor() {
        setTimeout(function () {
          ...
          style6.innerHTML =
            ".btn.program-cancel { background: none!important; border: 1px solid #5d5d5d!important;}";
          ...
          document.getElementById("pr-open").style.background =
            "var(--gray_text)";
        }, 10);
        setTimeout(function () {
          var style4 = document.createElement("style");
